...
class DecisionMaker:
    ...
    def analyze_question(
        ...
        """
        分析用户问题特征（增强版：支持LLM决策协作）

        Args:
            question: 用户问题
            conversation_history: 对话历史
            llm_decision: LLM的路由决策（可选，用于协作决策）
